...
namespace Emlak.Models
{
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Ilan(){Aciklama="ev güzel",Adres="şan sokak",OdaSayisi=5,BanyoSayisi=2,Kredi=true,Fiyat=2500,MahalleId=1,SemtId=1,SehirId=1,DurumId=1,TipId=1,Alan=250,Telefon="2125465252",Kat="2.Kat",UserName="alican"},
                new Ilan(){Aciklama="ev güzel 1",Adres="can sokak",OdaSayisi=4,BanyoSayisi=1,Kredi=true,Fiyat=2000,MahalleId=2,SemtId=2,SehirId=2,DurumId=2,TipId=4,Alan=150,Telefon="2129655445",Kat="4.Kat",UserName="ahmetcan"}
            };
